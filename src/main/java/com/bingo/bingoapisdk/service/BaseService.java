...
import com.bingo.bingoapisdk.exception.ErrorCode;
import com.bingo.bingoapisdk.exception.ErrorResponse;
import com.bingo.bingoapisdk.model.request.BaseRequest;
import com.bingo.bingoapisdk.model.response.ResultResponse;
import com.bingo.bingoapisdk.utils.SignUtils;
import lombok.Data;
...
public abstract class BaseService implements ApiService {
    private BingoApiClient qiApiClient;
    /**
     * 网关HOST
     */
    // todo 该成网关host
//    private String gatewayHost = "https://gateway.qimuu.icu/api";
     ...
     */
    public void checkConfig(BingoApiClient qiApiClient) throws ApiException {
     ...
     */
    private Map<String, String> getHeaders(String body, BingoApiClient qiApiClient) {
    ...
    @Override
    public <O, T extends ResultResponse> T request(BingoApiClient qiApiClient, BaseRequest<O, T> request) throws ApiException {
